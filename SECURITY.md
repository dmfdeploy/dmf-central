...
Report privately via GitHub's **[Report a vulnerability](https://github.com/dmfdeploy/dmf-central/security/advisories/new)**
(Security → Advisories → Report a vulnerability) on the `dmf-central` repository.
