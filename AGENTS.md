...
Central-services scaffold for the DMF Platform (deploy-once services; frozen for v0.1). See README.md and CLAUDE.md for repo specifics; cross-repo context —
status, decisions, plans — lives in the
[dmfdeploy umbrella repo](https://github.com/dmfdeploy/dmfdeploy), checked out
